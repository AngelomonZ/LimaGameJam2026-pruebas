...
public class MoveElfo : MonoBehaviour
{
    [Header("Movimiento")]
    ...
    void Update()
    {
        ...
        else anim.SetBool("Caminanding", false);
        if (movX > 0)
        {
        ...
        if (Input.GetKeyDown(KeyCode.LeftShift) && puedeDash && movX!=0)
        {
